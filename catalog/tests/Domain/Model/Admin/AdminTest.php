...
class AdminTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $catalog = \Mockery::mock('TShirtADay\Catalog\Domain\Model\Catalog\Catalog');
    ...
    public function record_that_a_tshirt_was_added_to_the_catalog()
    {
        ...
        $admin = new Admin;
        $admin->addTShirtWithDescriptionToCatalog('A Fat TShirt', $catalog);
        $this->assertInstanceOf('TShirtADay\Catalog\Domain\Model\TShirt\TShirtWasAddedToCatalog', $admin->getRecordedEvents()[0]);
    }
    ...
    public function record_that_a_tshirt_was_removed_from_the_catalog()
    {
        ...
        $this->assertInstanceOf('TShirtADay\Catalog\Domain\Model\TShirt\TShirtWasRemovedFromCatalog', $admin->getRecordedEvents()[0]);
    }
}